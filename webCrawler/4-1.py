...
siteData = [
    ['0\'Reilly Media', 'http://oreilly.com', 'h1', 'selection#product-description'],
    ['Reuters', 'http://reuters.com', 'h1', 'div.StandardAtricleBody_body_1gnLa'],
    ['Brookings', 'http://www.brookings.edu', 'h1','div.post-body']
]

websites = []
urls = [
    'http://show.oreilly.com/product/0636920028154.do',
