...
class ArticleSpider(CrawlSpider):
    ...
    rules = [Rule(LinkExtractor(allow=r'.*'), callback='parse_items', follow=True, cb_kwargs={'is_article' : True}), Rule(LinkExtractor(allow='.*'), callback='parse_items', cb_kwargs={'is_article' : False})]
    ...
    def parse_items(self, response, is_article):
        ...
        if is_article:
            ...
            print('This is noto an article: {}'.format(title))
